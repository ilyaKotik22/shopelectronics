...
const ItemPage = ({ item }: { item: BaseItem }) => {
    ...
    return (
        <main className="text-white dark:text-black mt-[5vh]">
            <form action={basketAddAction} className="block md:flex w-[90vw] justify-between">
                ...
                <section className=" md:w-[40vw]">
                    ...
                    <h3 className="text-[18px] mb-5">{price + " "}рублей</h3>
                        <section className="bg-neutral-800 dark:bg-neutral-200 px-7 py-3 rounded-md">
                            <div className="">{item.laptopSpec && 
                            Object.entries(item.laptopSpec)
                            .map(([key, value]) => (
                            <div className="flex justify-between border-b-1 mb-2 border-neutral-500 dark:" key={key}>
                                <div className="">
                                    {key}</div>
                                    <div className="
                                    ">{value}</div>
